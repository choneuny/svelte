<nav class="bg-black" style="position: Sticky; top:0px; z-index:999;">
	...
	<div class="sm:hidden" id="mobile-menu">
		<div class="px-2 pt-2 pb-3 space-y-1">
			...
			<a href={null} class="text-white hover:bg-gray-700 block px-3 py-2 rounded text-base font-medium">Team</a>

			<a href={null} class="text-white hover:bg-gray-700 block px-3 py-2 rounded text-base font-medium">Projects</a>

			<a href={null} class="text-white hover:bg-gray-700 block px-3 py-2 rounded text-base font-medium">Calendar</a>
		</div>
	</div>
	<!-- MOBILE MENU ENDS. -->
</nav>
