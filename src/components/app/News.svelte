...
{:else}
	<Window {styles}>
		<div class="dart bg-white flex flex-col items-center">
			<!--HEADER-->
			<div
				class="relative w-full h-1/8 bg-black flex flex-row items-center p-4 px-6 gap-4"
			>
				<div
					class="aspect-square border border-white flex flex-col justify-center"
				>
						...
						>
							...
							<div class="w-3/4 h-full flex flex-col overflow-auto gap-[1rem]">
								...
								<p class="text-[#999999] small" style="font-family:roboto;">
									입력 2022.{random(1, 12)}.{random(1, 30)}. 오후 {random(
										0,
										24
									)}:{random(0, 59)}
								</p>
								<p class="small" style="font-weight:500">
									{@html news[news_key.content].replace(
										/-/g,
										"<br />&nbsp;&nbsp;-"
									)}
								</p>
